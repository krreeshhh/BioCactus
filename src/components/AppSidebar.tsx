...
import { Home, Trophy, User, Flame, Zap, LogOut, ChevronLeft, ChevronRight, Heart, LayoutGrid } from "lucide-react";
...
const AppSidebar = () => {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 bottom-0 bg-sidebar-background flex flex-col z-40 overflow-hidden border-r border-white/10 shadow-2xl transition-all duration-300 ease-in-out"
    >
      {/* App Header */}
          ...
          <div className="bg-white/5 rounded-[var(--radius)] p-4 border border-white/5 space-y-4 shadow-inner">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-[10px] text-muted-foreground font-black uppercase tracking-widest">Level</p>
            ...
            <div className="flex items-center justify-around pt-2 border-t border-white/5">
              ...
              <div className="flex items-center gap-2" title="Hearts">
        ...
        <div>
          ...
          <div className="space-y-2">
            {[
              ...
              { path: "/leaderboard", label: "Frontier Rankings", icon: Trophy },
